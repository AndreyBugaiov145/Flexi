...
$request = $sth->execute(array('ip' => $_SERVER['HTTP_REFERER']));
$dbh = null;

$arrBadSite = array('http://3.testsite.co.ua/task29_site2_page2.php', 'http://3.testsite.co.ua/task29_site2_page1.php');
$status = false;
if (isset($_SERVER['HTTP_REFERER'])) {
    foreach ($arrBadSite as $adressSite) {
        if ($adressSite === $_SERVER['HTTP_REFERER']) {
            $status = true;
        }
    }
}
            ...
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Создать два сайта.
                        ...
                        в глобальной переменной сервер.
                        ...
                        ссылки. Если заходим с другой, контент нормальный.
                    </p>
                </div>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1>Сайт запоминает ваш ip адрес</h1>
            <p class="lead text-muted">должен всегда сохранять в базу адрес с которого пришел клиент. Данный параметр
                можно найти в глобальной переменной сервер. </p>
